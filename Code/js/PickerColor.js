...
function SetColorVar1() {
  const GetColor = document.getElementById("color-var1");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
...
function SetColorVar2() {
  const GetColor = document.getElementById("color-var2");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar3() {
  const GetColor = document.getElementById("color-var3");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar4() {
  const GetColor = document.getElementById("color-var4");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar5() {
  const GetColor = document.getElementById("color-var5");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar6() {
  const GetColor = document.getElementById("color-var6");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar7() {
  const GetColor = document.getElementById("color-var7");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar8() {
  const GetColor = document.getElementById("color-var8");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar9() {
  const GetColor = document.getElementById("color-var9");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar10() {
  const GetColor = document.getElementById("color-var10");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar11() {
  const GetColor = document.getElementById("color-var11");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar12() {
  const GetColor = document.getElementById("color-var12");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar13() {
  const GetColor = document.getElementById("color-var13");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar14() {
  const GetColor = document.getElementById("color-var14");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar15() {
  const GetColor = document.getElementById("color-var15");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar16() {
  const GetColor = document.getElementById("color-var16");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar17() {
  const GetColor = document.getElementById("color-var17");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar18() {
  const GetColor = document.getElementById("color-var18");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar19() {
  const GetColor = document.getElementById("color-var19");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
...
function SetColorVar20() {
  const GetColor = document.getElementById("color-var20");
  const SetColor = document.getElementById("picker-inside");
  const ColorStyle = window.getComputedStyle(GetColor);
  SetColor.style.backgroundColor = ColorStyle.backgroundColor;
